...
const features: Feature[] = [
  {
    ...
    description:
      "Each of our plans will provide you and your team with certifications.",
    icon: (
      <svg
      ...
      <div className="container max-w-6xl mx-auto px-5">
        ...
        <div className="grid grid-cols-4 gap-8 mt-10 sm:grid-cols-8 lg:grid-cols-12 sm:px-8 xl:px-0">
          {features.map((feature) => (
            <div
              key={feature.id}
              className="flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 bg-zinc-100 dark:bg-gray-800 sm:rounded-xl"
            >
              <div className="p-3 text-white bg-blue-500 rounded-full">
                {feature.icon}
              </div>
              <h4 className="text-xl font-medium text-zinc-700 dark:text-gray-100 text-center">
                {feature.title}
              </h4>
              <p className="text-base text-center text-zinc-500 dark:text-gray-300">
                {feature.description}
              </p>
            </div>
          ))}
